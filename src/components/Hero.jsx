...
//           <div className="mt-8 rounded-3xl bg-gradient-to-br from-rose-50 via-amber-50 to-sky-50 ring-1 ring-slate-200/60 h-[420px]" />
//         </div>
//       </div>
...
//               A serene Jain pilgrimage at Kundalpur. Experience peace,
//               devotion, and timeless heritage.
//             </p>
...
//             <div className="aspect-[4/3] overflow-hidden rounded-3xl shadow-2xl ring-1 ring-slate-200">
//               <img
//                 src="./src/assets/K0.jpg"
//                 alt="Shri Bade Baba Temple"
//                 className="h-full w-full object-cover"
//               />
//             </div>
//             <div className="absolute -bottom-6 -left-6 bg-white/70 backdrop-blur rounded-2xl px-4 py-3 shadow ring-1 ring-slate-200">
//               <div className="text-sm font-semibold">Daily Darshan</div>
//               <div className="text-xs text-slate-600">6:00 AM – 9:00 PM IST</div>
//             </div>
//           </div>
//         </div>
//       </div>
